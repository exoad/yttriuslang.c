...
module.exports = {
    ...
    try {
        ...
        if(!mole || mole == undefined) {
            ...
            .addField("Proper Usage", "`"+config.prefix+"molar {formula/compound}`")
            .addField("Description", "Input a chemical formula to get it's molar mass")
            .addField("Exclusions (Unreadable)", "1. `Tri` & `acetyl`\n2. `Ac` for `acetyl` (Write as CH3CO, etc.)\n3. Spaces are not allowed\n4. Make sure each letter is capitalzed correctly")
