...
module.exports = {
    ...
    try {
        ...
        if(!userTime) {
            ...
            .setDescription("This command is to get information on the moon on a certain day")
            .addField("Main Usage Formatting", "```"+config.prefix+"mphase [user_time]```")
            .addField("user_time", "**Accepted Parameters:**\n`YYYY/MM/DD`- Specific Date\n`today`- Get information on today")
