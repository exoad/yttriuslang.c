        ...
        try {
            ...
            if (!lat || !longi || lat == undefined || longi == undefined) {
                const embed = new MessageEmbed()
                    ...
                    .addField("Usage", `\`${config.prefix}earth {latitude} {longitude} {date}\``)
                    .addField("Additional Info", "1. Date should be in the following format: `YYYY-MM-DD` (Leave blank for today)\n2. If no image appears, that means the specified coordinates does not have any pictures on that day")
                    .addField("Example Usage", "`" + config.prefix + "earth 29.78 -95.33 2018-01-01`")
