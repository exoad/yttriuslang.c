        ...
        try {
            ...
            if (!lat || !lon || lat == undefined || lon == undefined) {
                const embed = new MessageEmbed()
                    ...
                    .addField(
                        "Description",
                        "This command is used to get sunset and sunrise times for a specific longtitude & latitude."
                    )
                    .addField(
                        "Usage",
                        "`" +
                        config.prefix +
                        "calcsun {latitude} {longitude} {time[OPTIONAL]}`"
                    )
                    .addField(
                        "Example Usage",
                        "`" + config.prefix + "calcsun 36.7201600 -4.4203400`"
                    )
                    .addField(
                        "{time[OPTIONAL]}",
                ...
                const embed = new MessageEmbed()
                    ...
                    .addField(
                        ...
                        body.results.civil_twilight_begin
                    )
                    .addField("End of Civil Twilight", body.results.civil_twilight_end)
                    .addField(
                        "Start of Nautical Twilight",
                        body.results.nautical_twilight_begin
                    )
                    .addField(
                        "End of Nautical Twilight",
                        body.results.nautical_twilight_end
                    )
                    .addField(
                        "Start of Astronomical Twilight",
                        body.results.astronomical_twilight_begin
                    )
                    .addField(
                ...
                const embed = new MessageEmbed()
                    ...
                    .addField(
                        ...
                        body.results.civil_twilight_end,
                        true
                    )
                    .addField(
                        "Start of Nautical Twilight",
            ...
            const embed = new MessageEmbed()
                ...
                .addField(
                    "I could not find anything based on the entered value",
