...
module.exports = {
    ...
    try {
        const embed = new MessageEmbed()
            ...
            .setDescription("Science Bot is a discord bot created by `exoad#4166`. It is a bot that incorporates science as its main focus.")
            .addField("Status", ready.status)
            .addField("Bot Package", "[Using a C++ Discord Bot API](https://github.com/yourWaifu/sleepy-discord)")
            .addField("APIs & Dependencies", "1. [NASA Open APIs](https://api.nasa.gov/)\n2. [LaTeX](https://github.com/latex3/)\n3. [Periodic Table Source](http://www.cplusplus.com/forum/general/89585/)\n4. [Wikipedia Public API](https://www.mediawiki.org/wiki/API:Main_page)")
            .addField("Topics Covered", "`Chemistry, Earth Science, Astronomy`")
            .addField("Extra notes", "Use `"+config.prefix+"support` for more info")
