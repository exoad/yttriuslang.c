...
module.exports = {
    ...
    try {
        ...
        if(!args[0] || args[0] == undefined) {
            ...
            .setDescription("You can find extra info here that couldn't make it into the command itself. Check with the command to search for the valid `{tags}`")
            ...
            .addField("Usage", "This bot's main purpose is of course to give information related to scientific topics.")
            .addField("News", "This bot is still in pre-alpha is always being updated with new features")
            .addField("Features", `Prefix: ${config.prefix}\nThis bot is not designed to multitask and perform things outside of its tasks`)
