            ...
            if (!equ || equ == undefined || equ == null) {
                const embed = new MessageEmbed()
                    ...
                    .addField(
                        ...
                        "The user, you, should have some knowledge of the language of `TeX` and/or `LaTeX`"
                    )
                    .addField(
                        "Usage",
                        "```" + config.prefix + "tex {formula_equation}```"
                    )
                    .addField(
                        "{formula_equation}",
                        "Input all necessary values here. Your equation, etc."
                    )
                    .addField(
                        "Example Usage",
                        "```" +
                        config.prefix +
                        "tex \\[ \\lim_{x \\to +\\infty} \\frac{3x^2 +7x^3}{x^2 +5x^4} = 3.\\] ```"
                    )
                ...
                message.channel
                    .send(
                        ...
                        message.author.discriminator, {
                            files: [{
                                attachment: `https://latex.codecogs.com/png.latex?\\inline&space;\\dpi{300}&space;\\bg_white&space;\\huge&space;${equ}`,
                                name: "final.png",
                            }, ],
                        }
                    )
