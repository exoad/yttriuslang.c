...
static inline bool speed_consumer_speaker(const CharT * st, bool * int i, value, len = strlen(str), values[] = {
    123,
    345
  };
}
...
static inline int blepi_consume_class_type(char *p, char_directives *s) {
  #ifdef DEBUG 
  debugf("bad starter :" + p)
  return 0;
  #endif
