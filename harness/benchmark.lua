...
--[[
    ...
    CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRADE_NOFUSED = 4,
    CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT_TILING        = 5    // results are deterministic
    ...
    CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD_NOFUSED = 5 // deterministic
    ]]--
